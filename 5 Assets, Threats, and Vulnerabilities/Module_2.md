<h2>Safeguard Information</h2>

data handling processes

security controls, information privacy, principle of least privilege
...
hash function: hash values are used to determine the integrity of files

non-repudiation: authenticity of files cannot be denied

sha256sum

<h2>Authentication, authorization, and accounting</h2>
...
accounting: auditing logs: user activity
